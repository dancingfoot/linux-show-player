...
class MessageDict:
    ...
    nested dict holds message id and value masks as keys and store commands or callbacks.
    ...
    def __set_mask(d, cmd, m):
        ...
        if len(m) > 1:
            ...
            if m[0] in d and isinstance(d[m[0]], dict):
...
if __name__ == "__main__":
    ...
    keys.add('note_on', 'INTERRUPT', (1, 3, 1))
    keys.add('note_on', 'NEXT', (1, 3, 2))
    ...
    print("size (3,1,1)       ", keys.size('note_on', (3, 1, 1)))
